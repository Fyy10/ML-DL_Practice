...
def process():
    ...
    datafile = os.path.join(Config.corpus, "formatted_movie_lines.txt")
    ...
    print("\nProcessing corpus...")
    lines = loadLines(os.path.join(Config.corpus, "movie_lines.txt"), MOVIE_LINES_FIELDS)
    print("\nLoading conversations...")
    conversations = loadConversations(os.path.join(Config.corpus, "movie_conversations.txt"),
    ...
    Config.save_dir = os.path.join("data", "save")
    voc, pairs = loadPrepareData(Config.corpus, Config.corpus_name, datafile, Config.save_dir)
